...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_path', type = str, default = '/home/pratik_narang/Chaitanya/rdd_to_hsi/', choices = ['track1', 'track2'], help = 'saving mode, and by_epoch saving is recommended')
    ...
    # Dataset parameters
    parser.add_argument('--baseroot', type = str, default = '../datasets/rdd_train', help = 'baseroot')
