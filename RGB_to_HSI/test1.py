...
if __name__ == "__main__":
    ...
    parser.add_argument('--val_path', type = str, default = './test_clean', help = 'saving path that is a folder')
    ...
    # Dataset parameters
    parser.add_argument('--baseroot', type = str, default = '../datasets/NTIRE2020_Test_Clean', help = 'baseroot')
